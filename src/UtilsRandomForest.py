...
def determineRFkFoldConfigurationMIPCA(ListXTrain, ListYTrain, ListXTest, ListYTest, explained_variance, min_t, max_t, step):
    print("\nComputing best configuration with Mutual Info and PCA on Random Forest...\n")

    script_path = Path(__file__)

    # Crea il percorso completo al file utilizzando pathlib
    serialize_dir = script_path.parent.parent / \
        "Serialized" / "BestConfigurationMIPCARandomForest.pkl"
